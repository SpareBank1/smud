        ...
        <div className="sb1-hero__inner">
            <div className="sb1-hero__preamble">
                <div className="sb1-hero__heading">
                    ...
                    <h1 className="ffe-h1">[smu:d]</h1>
                </div>
                <p className="ffe-body-text">Velkommen til en smud dag sammen med oss i SpareBank 1 Utvikling. Vi deler det vi brenner for. Hør oss fortelle om hvordan vi bygger digitale løsninger som kundene elsker og hvordan vi skaper høypresterende team.</p>
            </div>
        </div>
    </div>
        ...
        <GridRow reverse={true}>
            <GridCol sm={{ cols: 12 }} className="sb1-workplace">
                <div className="sb1-workplace__preamble">
                    <h3 className="ffe-h3">Program</h3>
                    <p className="ffe-body-text">Kommer!</p>
                </div>
